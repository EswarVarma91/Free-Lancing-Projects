...
class ListViewFamilyAdapter extends ArrayAdapter<ModelClassFamily> {
    ...
    public ListViewFamilyAdapter(List<ModelClassFamily> heroList, Context mCtx) {
        ...
        addfamilycheckbox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    ...
                    editor.putString("PRIMARYUSER",hero.getAadhar());
                    editor.putString("PRIMARYNAME",hero.getName());
                    editor.commit();

                    Toast.makeText(mCtx, "Primary User : "+hero.getName()+"\n"+hero.getAadhar(), Toast.LENGTH_SHORT).show();
                    addfamilycheckbox.setEnabled(false);
                }
            }
        });
