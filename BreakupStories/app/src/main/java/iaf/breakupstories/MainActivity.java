...
public class MainActivity extends AppCompatActivity {
    ...
    private String URL="http://iamfuture.hol.es/basapi.php?act=stories";
                ...
                try {
                    ...
                    for (int i = 0; i < heroArray.length(); i++) {
                        ...
                        ModelClass modelClass = new ModelClass(heroObject.getString("id"),
                                ...
                                heroObject.getString("mobile"), heroObject.getString("title"),
                                heroObject.getString("story"), heroObject.getString("Date"));


                        storiesList.add(modelClass);
                    }
                        //creating custom adapter object
                        mAdapter = new MainAdapter(storiesList, getApplicationContext());
